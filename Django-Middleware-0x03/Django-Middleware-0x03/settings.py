...
MIDDLEWARE = [
    ...
    'chats.middleware.OffensiveLanguageMiddleware',    # Custom middleware for time-based access restriction
]
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PAGINATION_CLASS': 'chats.pagination.MessagePagination',  # <- PageNumberPagination subclass
